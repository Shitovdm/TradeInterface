<div class="header">
    <div class="navbar">
        ...
        <a href="/index.php?page=pages/search_TMtoSteam.php">
            <div class="header_param header_hover <?php if ($page == 'pages/search_TMtoSteam.php') {
    echo("active_tab");
} ?>" id="navbar_search"  onClick="navbar('<?php echo($page); ?>')">
                <li>TM &#8658; Steam</li>
            </div></a>

        <a href="/index.php?page=pages/search_steamToTM (orders).php">
            <div class="header_param header_hover <?php if ($page == 'pages/search_steamToTM (orders).php') {
    echo("active_tab");
} ?>" id="navbar_search"  onClick="navbar('<?php echo($page); ?>')">
        ...
        <a href="/index.php?page=pages/search_steamToTM (sell).php">
            <div class="header_param header_hover <?php if ($page == 'pages/search_steamToTM (sell).php') {
    echo("active_tab");
} ?>" id="navbar_search"  onClick="navbar('<?php echo($page); ?>')">
                <li>Steam &#8658; TM (sell)</li>
            </div></a>
        ...
        <a href="/index.php?page=pages/item_info_TMtoST.php">
            <div class="header_param header_hover <?php if ($page == 'pages/item_info_TMtoST.php') {
    echo("active_tab");
} ?>" id="navbar_contacts"  onClick="navbar('<?php echo($page); ?>')">
                <li>Item's TM&#8658;ST</li>
            </div></a>

        <a href="/index.php?page=pages/item_info_STtoTM.php">
            <div class="header_param header_hover <?php if ($page == 'pages/item_info_STtoTM.php') {
    echo("active_tab");
} ?>" id="navbar_contacts"  onClick="navbar('<?php echo($page); ?>')">
                <li>Item's ST&#8658;TM</li>
            </div></a>
