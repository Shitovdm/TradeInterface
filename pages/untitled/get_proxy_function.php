        ...
        for ($k = 0; $k < count($API_resource); $k++) {
            if (($k == 0) || ($k == 1)) {
                ...
                if (($proxies == null)) {
                    ...
                    write_proxy_list('../lists/proxy_list_spys_one_API.txt', $residue);
                ...
                $spin_proxies = read_proxy_list('../lists/proxy_list_spinproxy.txt');
                if ($spin_proxies == null) {
                    ...
                    write_proxy_list('../lists/proxy_list_spinproxy.txt', $residue);
