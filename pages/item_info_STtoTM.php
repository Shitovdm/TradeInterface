<?php
    ...
    while ($row = mysql_fetch_assoc($select_data)) {
        ...
        if (((int) $sell_price[$i] > 1) && ((int) $sell_price[$i] <= 50)) {
            $sell_price_1_50++;
        }
        ...
        if (((int) $sell_price[$i] > 1000) && ((int) $sell_price[$i] < 5000)) {
            $sell_price_1000_5000++;
        }
        if ((int) $sell_price[$i] >= 5000) {
        ...
        if (((int) $buy_price[$i] > 1) && ((int) $buy_price[$i] <= 50)) {
            $buy_price_1_50++;
        }
        ...
        if (((int) $buy_price[$i] > 1000) && ((int) $buy_price[$i] < 5000)) {
            $buy_price_1000_5000++;
        }
        if ((int) $buy_price[$i] >= 5000) {
...
<script>
    ...
    function reCalculate(new_val, cell, old_val) {
        var received = Number($("#received_amount").text());
        var spent = Number($("#spent_amount").text());
